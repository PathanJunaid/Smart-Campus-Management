...
const AdminFaculty = () => {
    ...
    const handleAddFaculty = () => {
        toast.info("Add Faculty feature coming soon!");
    };
    ...
    const handleEditFaculty = (e, faculty) => {
        e.stopPropagation();
        toast.info(`Edit Faculty ${faculty.facultyName} coming soon!`);
    };

    const handleDeleteFaculty = (e, facultyId) => {
        e.stopPropagation();
        if (window.confirm("Are you sure you want to delete this faculty?")) {
            toast.info(`Delete Faculty ${facultyId} coming soon!`);
        }
    };
    ...
    const handleDeleteDepartment = (deptId) => {
        if (window.confirm("Are you sure you want to delete this department?")) {
            toast.info(`Delete Department ${deptId} coming soon!`);
        }
    };
                                        ...
                                        >
                                            ...
                                            <td className="text-end">
                                                <div className="action-buttons justify-content-end">
                                                    ...
                                                    <button className="btn-icon delete" title="Delete Faculty" onClick={(e) => handleDeleteFaculty(e, faculty.id)}>
